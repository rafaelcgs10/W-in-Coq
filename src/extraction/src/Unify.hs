...
type Coq_unify_type = () -> Prelude.Either Subst.Coq_substitution HoareMonad.UnifyFailure

unify'_obligation_1 :: SimpleTypes.Coq_id -> SimpleTypes.Coq_ty -> HoareMonad.UnifyFailure
unify'_obligation_1 i t =
  HoareMonad.Coq_occ_fail i t

unify'_obligation_4 :: SimpleTypes.Coq_ty -> SimpleTypes.Coq_id -> HoareMonad.UnifyFailure
unify'_obligation_4 t i =
  HoareMonad.Coq_occ_fail' i t

unify'_obligation_8 :: SimpleTypes.Coq_id -> SimpleTypes.Coq_id -> HoareMonad.UnifyFailure
unify'_obligation_8 i j =
  HoareMonad.Coq_diff_cons i j

unify'_obligation_11 :: Coq_constraints -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> HoareMonad.UnifyFailure ->
                        HoareMonad.UnifyFailure
unify'_obligation_11 _ l1 r1 l2 r2 e =
  HoareMonad.Coq_arrow_left l1 l2 r1 r2 e

unify'_obligation_14 :: Coq_constraints -> (Coq_constraints -> () -> Coq_unify_type) -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty
                        -> Subst.Coq_substitution -> HoareMonad.UnifyFailure -> HoareMonad.UnifyFailure
unify'_obligation_14 _ _ l1 r1 l2 r2 s1 e =
  HoareMonad.Coq_arrow_right l1 l2 r1 r2 s1 e

unify'_obligation_16 :: SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_id -> HoareMonad.UnifyFailure
unify'_obligation_16 wildcard' wildcard'0 wildcard'1 =
  HoareMonad.Coq_arrow_con wildcard'1 wildcard' wildcard'0

unify'_obligation_17 :: SimpleTypes.Coq_id -> SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> HoareMonad.UnifyFailure
unify'_obligation_17 wildcard' wildcard'0 wildcard'1 =
  HoareMonad.Coq_con_arrow wildcard' wildcard'0 wildcard'1

unify' :: Coq_constraints -> Prelude.Either Subst.Coq_substitution HoareMonad.UnifyFailure
unify' l =
  let {
   fix_F_sub x =
       ...
       case t of {
        ...
        SimpleTypes.Coq_con wildcard' ->
         case t0 of {
          ...
          SimpleTypes.Coq_arrow wildcard'0 wildcard'1 -> Prelude.Right (unify'_obligation_17 wildcard' wildcard'0 wildcard'1)};
          ...
          SimpleTypes.Coq_var i ->
           ...
           case filtered_var0 of {
            ...
            Prelude.False -> case SimpleTypes.eq_ty_dec (SimpleTypes.Coq_var i) t1 of {
                              Prelude.True -> Prelude.Left [];
                              Prelude.False -> Prelude.Left ((:) ((,) i t1) [])}};
          SimpleTypes.Coq_con wildcard'1 -> Prelude.Right (unify'_obligation_16 wildcard' wildcard'0 wildcard'1);
           ...
           case filtered_var0 of {
            Prelude.Left s ->
             ...
             case filtered_var1 of {
              ...
              Prelude.Right e -> Prelude.Right (unify'_obligation_14 x (\l0 _ -> unify'0 l0) wildcard' wildcard'0 l2 r2 s e)};
            Prelude.Right e -> Prelude.Right (unify'_obligation_11 x wildcard' wildcard'0 l2 r2 e)}}}})}
  in fix_F_sub l __
...
unify'' :: SimpleTypes.Coq_ty -> SimpleTypes.Coq_ty -> Specif.Coq_sigT Varctxt.Coq_varctxt (Prelude.Either Subst.Coq_substitution HoareMonad.UnifyFailure)
unify'' t1 t2 =
  ...
  case filtered_var of {
   Specif.Coq_existT _ s ->
    case s of {
     ...
     Prelude.Right error -> Specif.proj1_sig (HoareMonad.failT (HoareMonad.UnifyFailure' tau1 tau2 error) x)}})
