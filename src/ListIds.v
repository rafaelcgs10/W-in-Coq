...
Lemma in_list_id_cons : forall x l a,
    in_list_id x l = true ->
    in_list_id x (a::l) = true.
Proof.
  intros.
  mysimp.
Qed.
...
Proof.
  ...
  - destruct a.
    ...
    + unfold img_ids in H0. simpl in H0.
      ...
      induction t.
      apply IHs. simpl in H0. destruct (eq_id_dec i0 st); intuition; auto.
      unfold img_ids. auto.
      rewrite apply_subst_con. reflexivity.
