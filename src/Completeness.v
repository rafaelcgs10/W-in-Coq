...
Lemma id_increases_in_w : forall (e : term) (i i' : id) (G : ctx) (tau : ty) (s : substitution),
...
Lemma completeness : forall (e : term) (G : ctx) (tau' : ty) (phi : substitution) (i : id),
    ...
    exists s tau i' s', getResult (runInfer_id e G i) = Some (i', tau, s) /\ tau' = apply_subst s' tau /\
